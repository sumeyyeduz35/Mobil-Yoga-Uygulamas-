...
const AdvancedAshtangaYogaScreen = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        <Text style={styles.title}>Advanced Ashtanga Yoga</Text>
        <Image
          source={require('../assets/advanced_1.jpg')}
          style={styles.yogaImage}
        />
        <Text style={styles.description}>
          <Text style={styles.bold}>Advanced Ashtanga Yoga Nedir?{'\n\n'}</Text>
          ...
          <Text style={styles.bold}>Advanced Ashtanga Yoga Nasıl Yapılır?{'\n\n'}</Text>
        </Text>
        <Image
          source={require('../assets/advanced_2.jpg')}
        ...
        <Image
          source={require('../assets/advancedYapim.jpg')}
...
export default AdvancedAshtangaYogaScreen;
